...
static uint32_t qdsp_image0_queue_offset_table[] = {
	[QDSP_lpmCommandQueue] = 0x65a,
	[QDSP_mpuAfeQueue] = 0x5f2,
	[QDSP_mpuGraphicsCmdQueue] = QDSP_RTOS_NO_QUEUE,
	[QDSP_mpuModmathCmdQueue] = 0x606,
	[QDSP_mpuVDecCmdQueue] = 0x61e,
	[QDSP_mpuVDecPktQueue] = 0x622,
	[QDSP_mpuVEncCmdQueue] = 0x61a,
	[QDSP_rxMpuDecCmdQueue] = 0x5fa,
	[QDSP_rxMpuDecPktQueue] = 0x5fe,
	[QDSP_txMpuEncQueue] = 0x602,
	[QDSP_uPAudPPCmd1Queue] = 0x626,
	[QDSP_uPAudPPCmd2Queue] = 0x62a,
	[QDSP_uPAudPPCmd3Queue] = 0x62e,
	[QDSP_uPAudPlay0BitStreamCtrlQueue] = 0x63e,
	[QDSP_uPAudPlay1BitStreamCtrlQueue] = 0x642,
	[QDSP_uPAudPlay2BitStreamCtrlQueue] = 0x646,
	[QDSP_uPAudPlay3BitStreamCtrlQueue] = 0x64a,
	[QDSP_uPAudPlay4BitStreamCtrlQueue] = 0x64e,
	[QDSP_uPAudPreProcCmdQueue] = 0x632,
	[QDSP_uPAudRecBitStreamQueue] = 0x63a,
	[QDSP_uPAudRecCmdQueue] = 0x636,
	[QDSP_uPJpegActionCmdQueue] = 0x656,
	[QDSP_uPJpegCfgCmdQueue] = 0x652,
	[QDSP_uPVocProcQueue] = 0x5f6,
...
static uint32_t qdsp_gaudio_queue_offset_table[] = {
	...
	[QDSP_mpuAfeQueue] = 0x391,
	[QDSP_mpuGraphicsCmdQueue] = QDSP_RTOS_NO_QUEUE,
	[QDSP_mpuModmathCmdQueue] = 0x395,
	[QDSP_mpuVDecCmdQueue] = 0x399,
	...
	[QDSP_txMpuEncQueue] = 0x39d,
	[QDSP_uPAudPPCmd1Queue] = 0x3a1,
	[QDSP_uPAudPPCmd2Queue] = 0x3a5,
	[QDSP_uPAudPPCmd3Queue] = 0x3a9,
	[QDSP_uPAudPlay0BitStreamCtrlQueue] = QDSP_RTOS_NO_QUEUE,
	...
	[QDSP_uPAudPreProcCmdQueue] = QDSP_RTOS_NO_QUEUE,
	[QDSP_uPAudRecBitStreamQueue] = QDSP_RTOS_NO_QUEUE,
	[QDSP_uPAudRecCmdQueue] = QDSP_RTOS_NO_QUEUE,
...
static uint32_t qdsp_qtv_lp_queue_offset_table[] = {
	...
	[QDSP_rxMpuDecCmdQueue] = QDSP_RTOS_NO_QUEUE,
	[QDSP_rxMpuDecPktQueue] = QDSP_RTOS_NO_QUEUE,
	[QDSP_txMpuEncQueue] = 0x3d2,
	[QDSP_uPAudPPCmd1Queue] = 0x3d6,
	[QDSP_uPAudPPCmd2Queue] = 0x3da,
	[QDSP_uPAudPPCmd3Queue] = 0x3de,
	[QDSP_uPAudPlay0BitStreamCtrlQueue] = QDSP_RTOS_NO_QUEUE,
	[QDSP_uPAudPlay1BitStreamCtrlQueue] = QDSP_RTOS_NO_QUEUE,
	[QDSP_uPAudPlay2BitStreamCtrlQueue] = QDSP_RTOS_NO_QUEUE,
	[QDSP_uPAudPlay3BitStreamCtrlQueue] = QDSP_RTOS_NO_QUEUE,
...
static uint32_t qdsp_image5_queue_offset_table[] = {
	[QDSP_lpmCommandQueue] = QDSP_RTOS_NO_QUEUE,
	[QDSP_mpuAfeQueue] = 0x57a,
	[QDSP_mpuGraphicsCmdQueue] = QDSP_RTOS_NO_QUEUE,
	[QDSP_mpuModmathCmdQueue] = QDSP_RTOS_NO_QUEUE,
	[QDSP_mpuVDecCmdQueue] = QDSP_RTOS_NO_QUEUE,
	[QDSP_mpuVDecPktQueue] = QDSP_RTOS_NO_QUEUE,
	[QDSP_mpuVEncCmdQueue] = 0x582,
	[QDSP_rxMpuDecCmdQueue] = 0x586,
	[QDSP_rxMpuDecPktQueue] = 0x58a,
	[QDSP_txMpuEncQueue] = 0x58e,
	[QDSP_uPAudPPCmd1Queue] = 0x592,
	[QDSP_uPAudPPCmd2Queue] = 0x596,
	[QDSP_uPAudPPCmd3Queue] = QDSP_RTOS_NO_QUEUE,
	[QDSP_uPAudPlay0BitStreamCtrlQueue] = QDSP_RTOS_NO_QUEUE,
	[QDSP_uPAudPlay1BitStreamCtrlQueue] = QDSP_RTOS_NO_QUEUE,
	[QDSP_uPAudPlay2BitStreamCtrlQueue] = QDSP_RTOS_NO_QUEUE,
	[QDSP_uPAudPlay3BitStreamCtrlQueue] = QDSP_RTOS_NO_QUEUE,
